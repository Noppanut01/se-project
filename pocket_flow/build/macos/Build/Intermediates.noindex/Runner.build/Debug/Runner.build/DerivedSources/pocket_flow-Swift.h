...
#ifndef POCKET_FLOW_SWIFT_H
#define POCKET_FLOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pocket_flow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11pocket_flow11AppDelegate")
...
SWIFT_CLASS("_TtC11pocket_flow17MainFlutterWindow")
